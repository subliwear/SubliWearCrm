            ...
            <div class="bg-white/80 border border-slate-200 mb-4 mt-4 p-4 rounded flex flex-wrap flex-grow-0 flex-shrink-0 gap-10" v-if="message.is_custom">
                <div class="border rounded p-4" v-for="dnld in message.downloads">
                    ...
                    <div>
                        ...
                        &nbsp;
                        <a :href="dnld.url" target="_blank"   class="text-blue-800 text-sm"> <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-7h2V8h-2v5zm0 2h2v-2h-2v2z"/></svg>  <span class="underline">Show</span></a>
                    </div>
            ...
            <div class="bg-white/80 border border-slate-200 mb-4 mt-4 p-4 rounded flex flex-wrap flex-grow-0 flex-shrink-0 gap-10" v-else>
                ...
                <div class="border rounded p-4">
                    ...
                    <div v-if="message.patronage.download!=='' && message.patronage.download!==null && message.patronage.download!=='null'">
                        ...
                        &nbsp;
                        <a :href="message.patronage.download"  target="_blank" class="text-blue-800 text-sm"><svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-7h2V8h-2v5zm0 2h2v-2h-2v2z"/></svg> <span class="underline">Download</span></a>
                    </div>
