            ...
            <div class="flex-auto px-0 pt-0 pb-2">
              <div class="p-6 overflow-x-auto">
                <form action="{{route('options.save')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <input type="number" name="deadline"  value="{{$option->deadline}}" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Préciser une période" aria-label="Logo" list="suggestions">
