              ...
              <div class="overflow-x-auto">
                <div class="px-6 mb-4">
                    <form action="{{route('support-submit')}}" method="post">
                        ...
                        <div class="mb-4">
                            <input type="text" name="subject"  required class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Patronage title" aria-label="Name">
                        </div>
