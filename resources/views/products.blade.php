    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div class="flex w-full" style="gap: 30px">
                <div
                    class="relative w-50 flex-grow flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                    <div
                        class="p-6 flex pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        ...
                        <a class="ml-auto inline-block px-6 py-3 font-bold text-center text-white uppercase align-middle transition-all bg-transparent rounded-lg cursor-pointer leading-pro text-xs ease-soft-in shadow-soft-md bg-150 bg-gradient-to-tl from-gray-900 to-slate-800 hover:shadow-soft-xs active:opacity-85 hover:scale-102 tracking-tight-soft bg-x-25"
                            href="{{route('products-category-add')}}"> <i class="fas fa-plus" aria-hidden="true">
                                    ...
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            {{-- <td
                                                ...
                                                <div class="flex px-2 py-1">
                                                    <div class="flex flex-col justify-center">
                                                        <a href="{{route('products-by-category', $category)}}">View
                                            ...
                                            <td
                                                class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <a href="{{route('products-category-edit', $category)}}"
                                                    class="text-xs font-semibold leading-tight text-slate-400"> Edit </a>
                                                <form class="inline ml-2"
                                                    action="{{route('products-category-delete', $category)}}" method="post"
                                                    onsubmit="return confirm('Do you really want to delete this record?');">
                                                    @method('delete')
                                                    @csrf()
                                                    <button class="text-xs font-semibold leading-tight text-red-500"> Delete
                                                    </button>
                                                </form>
                                            </td>
                                        </tr>
                ...
                <div
                    ...
                    <div
                        ...
                        <h6>Patronages</h6>
                        <a class="ml-auto inline-block px-6 py-3 font-bold text-center text-white uppercase align-middle transition-all bg-transparent rounded-lg cursor-pointer leading-pro text-xs ease-soft-in shadow-soft-md bg-150 bg-gradient-to-tl from-gray-900 to-slate-800 hover:shadow-soft-xs active:opacity-85 hover:scale-102 tracking-tight-soft bg-x-25"
                            href="{{route('products-patronage-add')}}"> <i class="fas fa-plus" aria-hidden="true">
                            </i>&nbsp;&nbsp;Add New Patronage</a>
                    </div>
                    <div class="flex-auto px-0 pt-0 pb-2" >
                        <div class="p-0 overflow-x-auto" >
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <div class="flex px-2 py-1">
                                                    <div class="flex px-2 py-1">
                                                        <div>
                                                            <img src="{{ ($patronage->preview) }}"
                                                                class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                                                alt="{{$patronage->title}}">
                                                        </div>
                                                        <div class="flex flex-col justify-center">
                                                            <h6 class="mb-0 text-sm leading-normal">{{$patronage->title}}
                                                            </h6>
                                            ...
                                            <td
                                                ...
                                                <a href="{{route('products-patronage-edit', $patronage)}}"
                                                    class="text-xs font-semibold leading-tight text-slate-400"> Edit </a>
                                                <form class="inline ml-2"
                                                    action="{{route('products-patronage-delete', $patronage)}}"
                                                    method="post"
                                                    onsubmit="return confirm('Do you really want to delete this record?');">
                                                    @method('delete')
                                                    @csrf()
